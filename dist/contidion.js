...
var Condition = exports.Condition = function (_WeatherItem) {
    ...
    function Condition(date, temp, text) {
    ...
    _createClass(Condition, [{
        ...
        value: function getHtml() {
            ...
            _get(Condition.prototype.__proto__ || Object.getPrototypeOf(Condition.prototype), 'getWeatherItemHtml', this).call(this, 'temperature', this.temp);
